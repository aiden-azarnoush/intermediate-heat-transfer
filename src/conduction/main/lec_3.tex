...
\addcontentsline{toc}{section}{Transient Conduction}
...
\subsection*{The Lumped Capacitance Method}
\addcontentsline{toc}{subsection}{The Lumped Capacitance Method}
...
\begin{definition}[Biot number and the validity of lumping]
\[
...
\subsection*{Exact Solution for a Plane Wall}
\addcontentsline{toc}{subsection}{Exact Solution for a Plane Wall}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pics/lumped_vs_exact.png}
    \caption{Centre temperature of a plane wall: exact one-term solution against the lumped approximation for three Biot numbers (computed). The two agree for small Bi and diverge as Bi grows.}
\end{figure}

\subsection*{The Semi-Infinite Solid}
\addcontentsline{toc}{subsection}{The Semi-Infinite Solid}
...
\subsection*{Numerical Solution: Finite Differences}
\addcontentsline{toc}{subsection}{Numerical Solution: Finite Differences}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pics/fd_transient.png}
    \caption{Output of the code above at four times: the faces are held at 100\,\textdegree C and heat diffuses toward the centre (computed).}
\end{figure}

\subsection*{Where Conduction Meets the Rest of the Course}
\addcontentsline{toc}{subsection}{Where Conduction Meets the Rest of the Course}
